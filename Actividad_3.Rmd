...
kable(
  tabla_modelos,
  format = "html",
  caption = "Tabla X. Resultados de los modelos logisticos bivariados para la rotacion del personal",
  col.names = c(
...
El cutoff de la matriz de confusion se escogio teniendo en cuenta esta tabla debido a que tambien hay que tener en cuenta que los recursos en una empresa son limitados por lo que se escogio un cutoff razonable.
